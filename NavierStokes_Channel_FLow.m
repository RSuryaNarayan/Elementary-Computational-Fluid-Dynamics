...
mesh_x = 150; %number of cells discretized along the x-direction
mesh_y = 30; %number of cells discretized along the y-direction
...
%initialize variables for the Channel Flow problem
u(mesh_y+2,:) = 0; %north boundary is the pipe wall
u(1,:)=0; %south boundary is also the pipe wall
u(:,1) = 5; %entry velocity is 1 m/s
u(:,mesh_x+1)=5; %set the same velocity at outlet to conserve mass
u_old = u;
v_old = v;
